  ...
  const getTypeOptions = (
    ...
    switch (contentType) {
      case 'movie':
        return [
          ...baseOptions,
          { label: '喜劇', query: '喜剧', value: 'comedy' },
          { label: '愛情', query: '爱情', value: 'romance' },
          { label: '動作', query: '动作', value: 'action' },
          { label: '科幻', query: '科幻', value: 'sci-fi' },
          { label: '懸疑', query: '悬疑', value: 'suspense' },
          { label: '犯罪', query: '犯罪', value: 'crime' },
          { label: '驚悚', query: '惊悚', value: 'thriller' },
          { label: '冒險', query: '冒险', value: 'adventure' },
          { label: '音樂', query: '音乐', value: 'music' },
          { label: '歷史', query: '历史', value: 'history' },
          { label: '奇幻', query: '奇幻', value: 'fantasy' },
          { label: '恐怖', query: '恐怖', value: 'horror' },
          { label: '戰爭', query: '战争', value: 'war' },
          { label: '傳記', query: '传记', value: 'biography' },
          { label: '歌舞', query: '歌舞', value: 'musical' },
          { label: '武俠', query: '武侠', value: 'wuxia' },
          { label: '情色', query: '情色', value: 'erotic' },
          { label: '災難', query: '灾难', value: 'disaster' },
          { label: '西部', query: '西部', value: 'western' },
          { label: '紀錄片', query: '纪录片', value: 'documentary' },
          { label: '短片', query: '短片', value: 'short' },
        ];
      case 'tv':
        return [
          ...baseOptions,
          ...
          { label: '懸疑', query: '悬疑', value: 'suspense' },
          { label: '武俠', query: '武侠', value: 'wuxia' },
          { label: '古裝', query: '古装', value: 'costume' },
          { label: '家庭', query: '家庭', value: 'family' },
          { label: '犯罪', query: '犯罪', value: 'crime' },
          { label: '科幻', query: '科幻', value: 'sci-fi' },
          { label: '恐怖', query: '恐怖', value: 'horror' },
          { label: '歷史', query: '历史', value: 'history' },
      ...
      case 'show':
        return [
          ...baseOptions,
          { label: '真人秀', query: '真人秀', value: 'reality' },
          { label: '脱口秀', query: '脱口秀', value: 'talkshow' },
          { label: '音樂', query: '音乐', value: 'music' },
          { label: '歌舞', query: '歌舞', value: 'musical' },
        ];
      case 'anime-tv':
  ...
  const getRegionOptions = (
    ...
    switch (contentType) {
      ...
      case 'anime-movie':
        return [
          ...baseOptions,
          { label: '華語', query: '华语', value: 'chinese' },
          { label: '歐美', query: '欧美', value: 'western' },
          { label: '韓國', query: '韩国', value: 'korean' },
          { label: '日本', query: '日本', value: 'japanese' },
          { label: '中國大陸', query: '中国大陆', value: 'mainland_china' },
          { label: '美國', query: '美国', value: 'usa' },
          { label: '中國香港', query: '中国香港', value: 'hong_kong' },
          { label: '臺灣', query: '台湾', value: 'taiwan' },
          { label: '英國', query: '英国', value: 'uk' },
          { label: '法國', query: '法国', value: 'france' },
          { label: '德國', query: '德国', value: 'germany' },
          { label: '意大利', query: '意大利', value: 'italy' },
          { label: '西班牙', query: '西班牙', value: 'spain' },
          { label: '印度', query: '印度', value: 'india' },
          { label: '泰國', query: '泰国', value: 'thailand' },
          { label: '俄羅斯', query: '俄罗斯', value: 'russia' },
          { label: '加拿大', query: '加拿大', value: 'canada' },
          { label: '澳大利亞', query: '澳大利亚', value: 'australia' },
          { label: '愛爾蘭', query: '爱尔兰', value: 'ireland' },
          { label: '瑞典', query: '瑞典', value: 'sweden' },
          { label: '巴西', query: '巴西', value: 'brazil' },
          { label: '丹麥', query: '丹麦', value: 'denmark' },
        ];
      case 'tv':
      case 'anime-tv':
      case 'show':
        return [
          ...
          { label: '華語', query: '华语', value: 'chinese' },
          { label: '歐美', query: '欧美', value: 'western' },
          { label: '國外', query: '国外', value: 'foreign' },
          { label: '韓國', query: '韩国', value: 'korean' },
          { label: '日本', query: '日本', value: 'japanese' },
          { label: '中國大陸', query: '中国大陆', value: 'mainland_china' },
          { label: '中國香港', query: '中国香港', value: 'hong_kong' },
  ...
  const getLabelOptions = (
    ...
    switch (contentType) {
      case 'anime-movie':
        return [
          ...baseOptions,
          { label: '定格動畫', query: '定格动画', value: 'stop_motion' },
          { label: '傳記', query: '传记', value: 'biography' },
          { label: '美國動畫', query: '美国动画', value: 'us_animation' },
          { label: '愛情', query: '爱情', value: 'romance' },
          { label: '黑色幽默', query: '黑色幽默', value: 'dark_humor' },
          { label: '歌舞', query: '歌舞', value: 'musical' },
          { label: '兒童', query: '儿童', value: 'children' },
          { label: '二次元', query: '二次元', value: 'anime' },
          { label: '動物', query: '动物', value: 'animal' },
          { label: '青春', query: '青春', value: 'youth' },
          { label: '歷史', query: '历史', value: 'history' },
          { label: '勵志', query: '励志', value: 'inspirational' },
          { label: '惡搞', query: '恶搞', value: 'parody' },
          { label: '治癒', query: '治愈', value: 'healing' },
          { label: '運動', query: '运动', value: 'sports' },
          { label: '後宮', query: '后宫', value: 'harem' },
          { label: '情色', query: '情色', value: 'erotic' },
          { label: '人性', query: '人性', value: 'human_nature' },
          { label: '懸疑', query: '悬疑', value: 'suspense' },
          { label: '戀愛', query: '恋爱', value: 'love' },
          { label: '魔幻', query: '魔幻', value: 'fantasy' },
          { label: '科幻', query: '科幻', value: 'sci_fi' },
        ];
      case 'anime-tv':
        return [
          ...baseOptions,
          ...
          { label: '後宮', query: '后宫', value: 'harem' },
          { label: '情色', query: '情色', value: 'erotic' },
          { label: '國漫', query: '国漫', value: 'chinese_anime' },
          { label: '人性', query: '人性', value: 'human_nature' },
          { label: '懸疑', query: '悬疑', value: 'suspense' },
          { label: '戀愛', query: '恋爱', value: 'love' },
          { label: '魔幻', query: '魔幻', value: 'fantasy' },
  ...
  const getPlatformOptions = (
    ...
    switch (contentType) {
      ...
      case 'show':
        return [
          ...baseOptions,
          { label: '騰訊視訊', query: '腾讯视频', value: 'tencent' },
          { label: '愛奇藝', query: '爱奇艺', value: 'iqiyi' },
          { label: '優酷', query: '优酷', value: 'youku' },
          { label: '湖南衛視', query: '湖南卫视', value: 'hunan_tv' },
          { label: 'Netflix', query: 'Netflix', value: 'netflix' },
          { label: 'HBO', query: 'HBO', value: 'hbo' },
          { label: 'BBC', query: 'BBC', value: 'bbc' },
          { label: 'NHK', query: 'NHK', value: 'nhk' },
          { label: 'CBS', query: 'CBS', value: 'cbs' },
          { label: 'NBC', query: 'NBC', value: 'nbc' },
          { label: 'tvN', query: 'tvN', value: 'tvn' },
        ];
      default:
        return baseOptions;
    }
